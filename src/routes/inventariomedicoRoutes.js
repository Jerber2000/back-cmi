...
router.get('/codigo/:codigo',  ...auth, inventarioMiddleware.validarCodigo, perm, inventarioMedicoController.buscarPorCodigo);
...
router.put('/:id/sumar-stock', ...auth, inventarioMiddleware.validarId, inventarioMiddleware.validarSumarStock, perm, inventarioMedicoController.sumarStock);
